# Generated by Powerlevel10k configuration wizard on 2023-08-06 at 14:41 -03.
...
# slanted separators, sharp heads, round tails, 2 lines, disconnected, full frame,
...
() {
  ...
  typeset -g POWERLEVEL9K_STATUS_OK_PIPE_VISUAL_IDENTIFIER_EXPANSION='󰸟'
